        ...
        try {
            ...
            if (response.ok) {
                if (method == "DELETE") {
                    ...
                    showdata(response, "Successfully deleted the resource.", endTime - startTime, dataSize);
                    ...
                    if (getResponse.ok) {
                        ...
                        console.log(`Error: ${getResponse.status} ${getResponse.statusText}`);
                    }
                } else {
                    showdata(response, "Successfully updated the resource.", endTime - startTime, dataSize);
                }
            } else {
                console.log(`Error: ${response.status} ${response.statusText}`);
            }
